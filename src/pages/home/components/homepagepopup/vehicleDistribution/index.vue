<template>
    <div class="qwe">
        <el-dialog v-model="drawerFlag" title="报警详情">
            ...
            <div class="provinceScreen">
                <el-table :data="gridData" size="mini" height="435" stripe
                    ...
                    <el-table-column prop="operateTypeName" label="行业类型" sortable class-name="s-c-c" />
                    <el-table-column prop="vehicleLineRate" label="上线率" sortable class-name="s-c-c" >
                        <template #default="{ row }">{{ row.vehicleLineRate}}%</template>
                    </el-table-column>
                    <el-table-column prop="vehicleLineCount" label="上线车辆数" sortable class-name="s-c-c" />
                    <el-table-column prop="vehicleCount" label="车辆总数" sortable class-name="s-c-c" />
                </el-table>
...
<!--                    &lt;!&ndash; @prev-click="onPrev" @next-click="onNext" &ndash;&gt;-->
<!--                </div>-->
            </div>
        </el-dialog>
    </div>
