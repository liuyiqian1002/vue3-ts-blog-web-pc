<template>
    <div class="qwe">
        <el-dialog v-model="drawerFlag" title="车辆分布" v-loading="loading"  element-loading-text="加载中...">
            ...
            <div class="provinceScreen">
              <el-table
                ...
                <el-table-column prop="areaName" label="组织区域" sortable class-name="s-c-c"/>
                <el-table-column prop="vehicleCount" label="区域车辆数" sortable class-name="s-c-c"/>
                <el-table-column prop="vehicleTotalCount" label="车辆总数" sortable class-name="s-c-c"/>
                <el-table-column prop="rate" label="车辆占比" width="180" sortable class-name="s-c-c">
...
import { getVehicleInfo } from '@/api/home'
